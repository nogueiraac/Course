...
namespace Course {
    class Program {
        ...
        {
            BusinessAccount bAccount = new BusinessAccount(8010, "Arthur Cesar", 100.00, 500.0);
            Account acc = new Account(1001, "Anderson", 0.0);

            //UPCASTING
            Account acc1 = bAccount;
            Account acc2 = new BusinessAccount(1003, "Isabelle", 0.0, 200.0);
            Account acc3 = new SavingsAccount(1004, "Cristiano", 0.0, 0.01);
